...
int main(int argc, char* argv[]) {
   ...
   */
	...
	if (attr_FAIL) {                                                          //ensure attribute was initialized successfully (return 0 == success)
		...
		fprintf(filePtr, filePtr, "***ATTR CREATION FAILED.***\n");
		exit(1);
	}
	...
	if (attr_FAIL) {                                                          //ensure attribute was modified successfully (return 0 == success)
		...
		fprintf(filePtr, filePtr, "**ATTR MODIFY FAILED.***\n");
		exit(1);
	}
	...
	if (pthread_FAIL) {
		...
		fprintf(filePtr, filePtr, "***THREAD CREATION FAILED***\n");
		exit(1);
	}
	...
	if (pthread_FAIL) {
		...
		fprintf(filePtr, filePtr, "***THREAD JOIN FAILED***\n");
		exit(1);
	}
